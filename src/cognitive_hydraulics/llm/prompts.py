    ...
    def generate_operators_prompt(
        ...
        parts.extend(
            [
                ...
                "- read_file: Read a file {'path': 'filename'}",
                "- list_dir: List directory contents {'path': 'dirname'}",
                "- search: Search for text {'term': 'search_term'}",
                "",
                "Provide operators that are immediately actionable.",
            ]
        )
    ...
    def evaluate_utilities_prompt(
        ...
        parts.extend(
            [
                ...
                "",
                "Provide estimates for all operators and recommend the best one.",
            ]
        )
